...
COMMENT ON COLUMN retail.brand_product_settings.is_available IS 'Whether this product is active (visible to affiliates). true = Active, false = Disabled. Disabled products are hidden from affiliate storefronts.';
