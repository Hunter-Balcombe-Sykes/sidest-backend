-- Recreate public_site_payload view to include services
...
COMMENT ON VIEW core.public_site_payload IS 'Complete public site payload including all blocks and services, with RLS enforced via security_invoker';
