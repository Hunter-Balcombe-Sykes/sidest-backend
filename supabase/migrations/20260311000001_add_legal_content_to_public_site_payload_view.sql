-- Include active legal content in the public site payload.
...
COMMENT ON VIEW core.public_site_payload IS 'Complete public site payload with image pools, services, and active legal content';
