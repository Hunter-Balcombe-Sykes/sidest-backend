...
Route::prefix('staff')
    ->middleware(['supabase.jwt', 'require.email_verified', 'staff', 'throttle:staff', 'staff.audit'])
...
Route::prefix('staff')
    ->middleware(['supabase.jwt', 'require.email_verified', 'staff', 'staff.admin', 'throttle:staff', 'staff.audit'])
    ->whereUuid('professional')
    ->scopeBindings()
    ->group(function () {
